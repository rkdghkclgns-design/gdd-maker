...
다음 형식의 JSON만 출력하세요 (코드블록 없이 순수 JSON):
{
  ...
  "slides": [
    ...
    { "type": "flow", "data": { "section":"02", "sectionName":"플로우 차트", "title":"...", "direction":"vertical|horizontal|grid", "lines": 1, "nodes":[{"kind":"start|process|decision|end","label":"단계 라벨 + 조건/시간 등 핵심 메타","edgeLabel":"다음 화살표 분기 라벨 — decision 노드엔 Yes/No 등 필수, 그 외 빈 문자열"}] } },
