...
const GDD_INGAME = {
  ...
  slides: [
    ...
    S.history({
      title: '문서 이력',
      rows: [
        { ver: 'Ver01', date: '26.02.25', page: '-', content: '최초 작성', author: '작성자' },
        { ver: 'Ver02', date: '26.02.27', page: '5, 10, 14p', content: '플레이어 상태 제거(Result)', author: '작성자' },
      ],
    }),
    S.toc({
      title: 'CONTENTS',
...
const GDD_VEHICLE = {
  ...
  slides: [
    ...
    S.history({
      title: '문서 이력',
      rows: [
        { ver: 'Ver00', date: '26.02.12', page: '-', content: '최초 작성', author: '작성자' },
      ],
    }),
    S.toc({
      title: 'CONTENTS',
  ...
  return {
    ...
    slides: [
      ...
      S.history({
        title: '문서 이력',
        rows: [
          { ver: 'Ver00', date: new Date().toISOString().slice(2, 10).replace(/-/g, '.'), page: '-', content: '최초 작성 (AI 생성)', author: '작성자' },
        ],
      }),
      S.toc({
        title: 'CONTENTS',
